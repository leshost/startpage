...
2. **Налаштуйте базу даних:**
   ...
   **Вам НЕ потрібно створювати таблиці вручну!** При першому відкритті головної сторінки (`index.php`) система автоматично створить усі необхідні таблиці та зв'язки між ними:
   - `users` (зберігання акаунтів, хешів паролів та секретних ключів)
   - `sites` (зберігання закладок, їх порядку, іконок та прив'язка до користувача)
   - `tasks` (зберігання завдань для Канбан-дошки)
