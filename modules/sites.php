...
try {
    ...
    try {
        $pdo->exec("ALTER TABLE `secrets` ADD COLUMN `do_not_delete` BOOLEAN DEFAULT FALSE");
    } catch (PDOException $e) {}
    try {
        $pdo->exec("ALTER TABLE `secrets` ADD COLUMN `is_unencrypted` BOOLEAN DEFAULT FALSE");
    } catch (PDOException $e) {}
    try {
